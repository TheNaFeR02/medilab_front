...
const SignIn = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://127.0.0.1:8000/auth/get-csrf-token/', {
      method: 'GET',
      credentials: 'include',
    }).then((response) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('http://127.0.0.1:8000/auth/dj-rest-auth/login/', {
        method: 'POST',
        headers: {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    // Actualizar el estado con los nuevos valores de los campos
        ...
        succesfullLogin === true
          ...
          (
            ...
            <div className='flex justify-center items-center h-screen '>
              <div className="w-3/5 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="flex flex-wrap items-center">
                  ...
                  <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                    <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                      <span className="mb-1.5 block font-medium">Medilab IPS</span>
                      <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                        Inicia Sesión en Medilab
                      </h2>
