  ...
  return (
    <>
      <div className='flex justify-center items-center'>
        <div className="w-3/5 mt-8  rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form>
                  ...
                  <div className="mt-6 text-center">
                    <p>
                      ...
                      <Link to="/iniciar_sesion" className="text-primary">
                        Inicia Sesión
                      </Link>
                    </p>
                  </div>
